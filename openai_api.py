...
async def create_chat_completion(request: ChatCompletionRequest):
    ...
    #     messages.append({"role": "assistant", "content": "你好，我是AiMed"})
...
if __name__ == "__main__":
    ...
    # tokenizer = Auto=-Tokenizer.from_pretrained("THUDM/chatglm2-6b", trust_remote_code=True)
